export default function Footer() {
  return (
    <footer className="footer footer-center items-center p-4 bg-base-300 text-base-content mt-4">
      <div className="items-center grid-flow-col">
        ...
        <p>Castle-Eos Copyright &copy; 2023 - All right reserved by FreshDevs</p>
      </div>
    </footer>
  )
}
